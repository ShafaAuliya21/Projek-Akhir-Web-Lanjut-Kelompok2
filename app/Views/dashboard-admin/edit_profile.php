		...
		<div class="top-navbar">
            ...
            <div class="container-create">
                ...
                <div class = "profile-saya">
                    <h1 class="input-pendaftaran">Edit Profile</h1>
                    <br>
                <div class="text">
                <form action="<?=base_url('admin/profile/' . $admin['id'])?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PUT">
                <?= csrf_field()?>
                <table>
                <tr>
                    <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" placeholder="Nama" aria-label="Nama" aria-describedby="basic-addon1" name="nama" value="<?= $admin['nama']?>" required>
