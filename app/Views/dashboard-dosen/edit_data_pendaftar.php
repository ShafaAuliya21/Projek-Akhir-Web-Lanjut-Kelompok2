...
<div class="body-overlay"></div>
        ...
        <div class="text">
        <form action="<?=base_url('dosen/pendaftaran/' . $pendaftaran['id'])?>" method="post" enctype="multipart/form-data">
        ...
        <br>
        <tr>
        <select class="form-select" aria-label="Default select example" id="status" name="status" required placeholder="Status Seminar" required>
                    <option>Status</option>
                    <option value="Terima" <?= ($pendaftaran['status'] == 'Terima') ? 'selected' : ''; ?>>Terima</option>
                    <option value="Tolak" <?= ($pendaftaran['status'] == 'Tolak') ? 'selected' : ''; ?>>Tolak</option>
                </select>
        </tr>
        <br>
        <tr>
