...
<div class="body-overlay"></div>
        ...
        <div class="text">
        <form action="<?=base_url('dosen/review/store/' . $pendaftaran['id'])?>" method="post" enctype="multipart/form-data">
        <?= csrf_field()?>
        <table>
            <br>
            <br>
        ...
        <tr>
            <input type="text" class="form-control <?= ($validation->hasError('kritik_saran')) ? 'is-invalid' : ''; ?>" placeholder="Kritik dan Saran" aria-label="Kritik dan Saran" aria-describedby="basic-addon1" name="kritik_saran" required>
        ...
        <br>
        <tr>
            <input type="text" class="form-control <?= ($validation->hasError('nilai')) ? 'is-invalid' : ''; ?>" placeholder="Nilai" aria-label="Nilai" aria-describedby="basic-addon1" name="nilai" required>
            <div class="invalid-feedback">
