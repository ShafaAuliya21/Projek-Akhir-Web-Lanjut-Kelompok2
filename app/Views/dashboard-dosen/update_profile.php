...
<div class="body-overlay"></div>
        ...
        <div class="text">
        <form action="<?=base_url('dosen/profile/' . $dosen['id'])?>" method="post" enctype="multipart/form-data">
        ...
        <tr>
            <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" placeholder="Nama" aria-label="Nama" aria-describedby="basic-addon1" name="nama" value="<?= $dosen['nama']?>" required>
